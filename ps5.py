...
class AndTrigger(Trigger):
    def __init__(self, trigger1, trigger2):
        self.trigg1 = trigger1
        self.trigg2 = trigger2
    def evaluate(self, story):
...
def filter_stories(stories, triggerlist):
    ...
    for story in stories:
        for trigg in triggerlist:
            if trigg.evaluate(story):
                trigg_story.append(story)
                break
    return trigg_story
...
def main_thread(master):
    ...
    try:
        ...
        while True:
            ...
            stories = process("https://news.google.com/rss?hl=en-IN&gl=IN&ceid=IN:en")
